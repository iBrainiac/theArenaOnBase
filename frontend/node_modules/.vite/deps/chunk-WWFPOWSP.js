...
var ICONS = {
  add: async () => (await import("./add-3J6K7KGF.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-TZ5LOQXO.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-2I23VENW.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-F3RZM5IQ.js")).appStoreSvg,
  apple: async () => (await import("./apple-7THJVBD6.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-F5GHT3FJ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-GX5QTQVM.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-GU2GWI7J.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-FAUCSJCT.js")).arrowTopSvg,
  bank: async () => (await import("./bank-BTG7NY7B.js")).bankSvg,
  browser: async () => (await import("./browser-PXE3AVGB.js")).browserSvg,
  card: async () => (await import("./card-WQFZYJQP.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-V33TCLWP.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-6F3TWAGT.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-4I7TPQI2.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-ZJ4AYRN3.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-QYSEFXLP.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-W2RBPDYU.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-PJAGZJIA.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ZAQDCLZZ.js")).clockSvg,
  close: async () => (await import("./close-7NBSGT5J.js")).closeSvg,
  compass: async () => (await import("./compass-GUIGCUIX.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-4WVRESOE.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-B26AKFH3.js")).copySvg,
  cursor: async () => (await import("./cursor-Q6XCTXF5.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-I37IFWFW.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-G7X4AFRY.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-QSYIBAKY.js")).disconnectSvg,
  discord: async () => (await import("./discord-ERYLPZXY.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-UIFY4WEB.js")).etherscanSvg,
  extension: async () => (await import("./extension-ZC4ADFXK.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-7BPWGGLZ.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-WFOF4YTG.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-3NIJJNED.js")).farcasterSvg,
  filters: async () => (await import("./filters-AANAIP2L.js")).filtersSvg,
  github: async () => (await import("./github-GPRXAPQF.js")).githubSvg,
  google: async () => (await import("./google-PF4CV66O.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-MWGL4JUW.js")).helpCircleSvg,
  image: async () => (await import("./image-JFAHDJVG.js")).imageSvg,
  id: async () => (await import("./id-CEGAAH44.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-VKVWO5AO.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-M4BBXTXW.js")).lightbulbSvg,
  mail: async () => (await import("./mail-IDQRO32W.js")).mailSvg,
  mobile: async () => (await import("./mobile-JEWXNM2P.js")).mobileSvg,
  more: async () => (await import("./more-UO5F2AVS.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-SSP2V5Z4.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-WAEE6NN6.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-LSJXBWH2.js")).offSvg,
  playStore: async () => (await import("./play-store-ZESUK47J.js")).playStoreSvg,
  plus: async () => (await import("./plus-GBBWPY5C.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-FOPLJMUN.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-2BD5MUAA.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-AKFD5JCJ.js")).refreshSvg,
  search: async () => (await import("./search-6Q6C76RX.js")).searchSvg,
  send: async () => (await import("./send-ER5C3MRP.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-RWXDAVEG.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-VTO52TBF.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-PL7DO5CQ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-EM5MF66B.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-5WOVGQPK.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-J542ZJSW.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-2SPCGEHE.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-7UWMYHYU.js")).twitchSvg,
  twitter: async () => (await import("./x-LCOCALT6.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-6WDA75J7.js")).twitterIconSvg,
  verify: async () => (await import("./verify-BCHSUEFJ.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-UZHFFHHV.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-Z36Y455E.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-7SQENJRR.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-7SQENJRR.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-7SQENJRR.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-OAQ2VRUF.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-QGGAVO5X.js")).warningCircleSvg,
  x: async () => (await import("./x-LCOCALT6.js")).xSvg,
  info: async () => (await import("./info-YHWUEJGO.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-VS3M3K5V.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-6ZDR5D2W.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WWFPOWSP.js.map
